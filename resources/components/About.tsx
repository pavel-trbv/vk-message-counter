    ...
    return (
        <>
            ...
            <Text lineHeight="6" mb="4">
                ...
                messages is
                carried out using the VK API.
                <br/>
                <br/>
                Source code: <Link href="https://github.com/pavel-trbv/https://github.com/pavel-trbv/vk-message-counter"
                                   color="blue.500">vk-message-counter </Link>
            </Text>
        </>
    );
};
